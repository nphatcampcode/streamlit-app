...
def main():
   ...
   # st.sidebar.image(gif_bytes)
    ...
    st.sidebar.markdown("""
                        ...
                        **<h2>AI-Powered Career Advisor: Making Smarter Choices Together</h2>** 

                        Step into the Future with Career Navigator! Our advanced AI delivers tailored career advice, guiding you towards your ideal job with insights and data-driven recommendations.
                        **Why Choose AI-Powered Career Advisor?**

                        - **Personalized Guidance: Receive career advice tailored to your skills, interests, and aspirations..
                        - **Live Job Listings: Get real-time updates and comparisons of job postings..
                        - **Skills Assessment: Discover your strengths and identify areas for improvement to enhance your career prospects..
                        - **Resume Creator: Design and download a professional resume.

                        **How to use Smart Decision Assistant**
                        1. Select your preferred method to upload your background. 
...
unsafe_allow_html=True)
    ...
    with col1:
        selection = st.selectbox("Choose upload background method", ["Resume Scanner","Manual (Typing)"], 0)
    ...
    st.title('Build resume').markdown("""<h2 class="text-center mb-4">Resume Builder</h2>
        <iframe src="https://resume-builder-tn2024.onrender.com/" style="width:100%; height:1200px; border:none;" title="Resume Builder"></iframe>""",unsafe_allow_html=True)
